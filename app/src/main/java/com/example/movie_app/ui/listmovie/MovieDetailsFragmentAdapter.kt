...
class MovieDetailsFragmentAdapter : RecyclerView.Adapter<MovieDetailsFragmentAdapter.MovieDetailsFragmentViewHolder>() {

    class MovieDetailsFragmentViewHolder(val binding: MovieItemDesignBinding) : RecyclerView.ViewHolder(binding.root)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MovieDetailsFragmentViewHolder {
        val binding = MovieItemDesignBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return MovieDetailsFragmentViewHolder(binding)
    }

    override fun onBindViewHolder(holder: MovieDetailsFragmentViewHolder, position: Int) {
